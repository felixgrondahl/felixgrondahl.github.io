...
const Footer = ({ projects }: { projects: boolean }) => {
  return (
    <Wrapper mobileShow={projects}>
      <Icons>
        <a href="https://www.linkedin.com/in/felix-gr%C3%B6ndahl-2aba321b0/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
        ...
        <a href="mailto:felix.grondahl@gmail.com" target="_blank" rel="noopener noreferrer">
