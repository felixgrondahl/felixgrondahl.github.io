      ...
      <S.ProjectWrapper>
        <S.ProjectBody>
          ...
          <div>
            ...
            <S.ProjectVideo src={MapGenVideo} itemType="video/mp4" loop autoPlay muted half={false} />
          </div>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <S.ProjectVideo src={RunVideo} itemType="video/mp4" loop autoPlay muted half={true} />
            <S.ProjectVideo src={IdleVideo} itemType="video/mp4" loop autoPlay muted half={true} />
          </div>
        </S.ProjectBody>
      </S.ProjectWrapper>
    </ProjectMidWrapper>
